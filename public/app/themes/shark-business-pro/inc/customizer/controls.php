 ...
 */
Class Shark_Business_Pro_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Shark_Business_Pro_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Shark_Business_Pro_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="shark-business-pro-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
Class Shark_Business_Pro_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
