...
class Shark_Business_Pro_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'shark_business_pro';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'shark-business-pro' ), $i ),
...
// Initialize.
$shark_business_pro_footer_widgets = new Shark_Business_Pro_Footer_Widgets();
