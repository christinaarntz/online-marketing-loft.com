jQuery(document).ready(function($) {
    ...
    $( document ).on( 'click', '.widget_multi_add_field', shark_business_pro_widget_multi_add_field )
        .on( 'change', '.widget_multi_single_field', shark_business_pro_widget_multi_single_field )
        .on( 'click', '.widget_multi_remove_field', shark_business_pro_widget_multi_remove_field )

    function shark_business_pro_set_multi_add_field() {
    ...
    shark_business_pro_set_multi_add_field();
    
    function shark_business_pro_widget_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            shark_business_pro_widget_multi_write( $control );
    }

    function shark_business_pro_widget_multi_single_field() {
        var $control = $( this ).parents( '.widget_multi_input' );
        shark_business_pro_widget_multi_write( $control );
    }

    function shark_business_pro_widget_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.widget_multi_input' );
        $this.parent().remove();
    ...
    function shark_business_pro_widget_multi_write( $element) {
    ...
    $(document).on("click", ".shark-business-pro-accordion", function (e) {
        e.preventDefault();
        var $button = $(this);

        $button.next('.shark-business-pro-panel').slideToggle();
    ...
    function shark_business_pro_contentTypeChange() {
    ...
    shark_business_pro_contentTypeChange();

    function shark_business_pro_widget_chosen() {
        $(".shark-business-pro-widget-chosen-select").chosen({
            width: "100%"
        });
    }
    shark_business_pro_widget_chosen();

    $(document).on('widget-updated widget-added', function(){

        // icon picker
        $('.shark-business-pro-icon-picker').each( function() {
