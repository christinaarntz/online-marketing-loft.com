...
if ( ! class_exists( 'Shark_Business_Pro_Featured_Widget' ) ) :

     
    class Shark_Business_Pro_Featured_Widget extends WP_Widget {
        /**
        ...
        public function __construct() {
            ...
            parent::__construct( 'shark_business_pro_featured_widget', esc_html__( 'ST: Featured Widget', 'shark-business-pro' ), $st_widget_featured );
        }
                                        ...
                                        <div class="post-wrapper">
                                            ...
                                            <div class="entry-container">
                                                ...
                                                <div class="entry-content">
                                                    <?php echo esc_html( shark_business_pro_trim_content( absint( $excerpt_length ) ) ); ?>
                                                </div><!-- .entry-content -->
                                                <div class="read-more">
        ...
        public function form( $instance ) {
            $title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Featured', 'shark-business-pro' );
            $sub_title      = isset( $instance['sub_title'] ) ? ( $instance['sub_title'] ) : esc_html__( 'Featured widget allows you to feature any WordPress post', 'shark-business-pro' );
            $count      = isset( $instance['count'] ) ? $instance['count'] : 3;
            $column     = isset( $instance['column'] ) ? $instance['column'] : 'column-3';
            $excerpt_length = isset( $instance['excerpt_length'] ) ? $instance['excerpt_length'] : 20;
            $content_type   = isset( $instance['content_type'] ) ? $instance['content_type'] : 'page';
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'No of Featured Posts:', 'shark-business-pro' ); ?></label>
